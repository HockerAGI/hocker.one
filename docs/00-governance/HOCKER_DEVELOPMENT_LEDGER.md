...
last_verified_at: 2026-08-16T06:55:52-07:00
...
- Hocker One PR #215 head `0c4ba7c5d11e46b1c95c8af3dffe399581fd602b`: Preview `dpl_6KDJcteoLnYj9HGVS6Z1HAty1yqN` = `READY`; GitHub Actions CI run `31948995696` = `SUCCESS`.
...
6. **Ledger promotion gate is exact-head green but not fully authorized:** PR #215 head `0c4ba7c...` has exact-head CI SUCCESS and Vercel Preview READY, but no review is approved and branch-protection requirements remain unreadable through the current integration.
...
- Hocker One #215 head `0c4ba7c...` has CI SUCCESS and Vercel Preview READY, but no PR review is approved and branch protection remains `PENDING EVIDENCE`.
