...
PR #139 se fusionó después de CI y matriz Android completa en verde, incluyendo Emulator QA en API 36 y Preview Vercel verificada. Persiste un riesgo residual documentado: la combinación AGP 8.10.1 + Gradle 9.7.0 no figura como combinación explícitamente probada en la matriz del proveedor, aunque la matriz real del repositorio pasó end-to-end.

PR #131 (TypeScript 7) permanece en HOLD por tratarse de una migración mayor que requiere validación dedicada.
...
2. Tratar TypeScript 7 como migración mayor independiente, con sus propios gates.
