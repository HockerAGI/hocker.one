...
See `docs/operations/CONTINUITY_REALITY_2026-09-03.md` for the complete current reality-vs-canon matrix, provider inventory, consolidation decision and open evidence gates.
