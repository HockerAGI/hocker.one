      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="animate-in fade-in slide-in-from-top-4 duration-500">
          <Hint title="Arquitectura de Mando">
            Cada agente opera en un perímetro estricto. La orquestación central de NOVA garantiza ejecución sin colisiones.
          </Hint>
        </div>

        {/* REGISTRO */}
        <div className="grid grid-cols-1 gap-6">
          <div className="hocker-panel-pro p-1 shadow-sky-500/5 min-h-[300px]">
            <AgisRegistry title="Estado de Agentes" className="border-none" />
          </div>
        </div>

        {/* TELEMETRÍA */}
        <section className="hocker-glass-vfx p-8 bg-gradient-to-br from-indigo-500/5 to-transparent animate-in fade-in slide-in-from-bottom-6 duration-700">
            ...
            {[
              ...
              <div key={item.label} className="space-y-2">
                ...
                <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-sky-500 shadow-[0_0_8px_#0ea5ff]"
