...
export async function GET(req: Request) {
  const trace = langfuse.trace({ name: "Commands_GET", metadata: { endpoint: "/api/commands" } });
  try {
...
export async function POST(req: Request) {
  const trace = langfuse.trace({ name: "Commands_POST", metadata: { endpoint: "/api/commands" } });
