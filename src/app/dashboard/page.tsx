      ...
      <div className="flex flex-col gap-10">
        ...
        <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
          {metrics.map((m, i) => (
            <div
              key={i}
              className="hocker-panel-pro relative overflow-hidden p-6 group transition-all hover:scale-[1.02]"
            >
              <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-700 ${
                m.ok ? "bg-emerald-500/5" : "bg-rose-500/5"
              }`} />

              <div className={`absolute -right-6 -top-6 h-28 w-28 rounded-full blur-3xl ${
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <div className="flex flex-col gap-8 lg:col-span-8 animate-in fade-in slide-in-from-left-4 duration-700">
            ...
            <section className="hocker-glass-vfx p-8 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h2 className="mt-2 text-2xl font-black tracking-tight text-white hocker-text-glow">
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-2">
                  {pillars.map((p, i) => (
                    <div
                      key={i}
                      className="rounded-2xl border border-white/5 bg-slate-950/40 p-5 transition-all hover:border-sky-500/30 hover:bg-slate-900/60 hover:scale-[1.02]"
                    >
            ...
            <section className="flex flex-col gap-4">
              <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 px-2">
                Bitácora de Eventos
              </h3>
          ...
          <aside className="flex flex-col gap-8 lg:col-span-4 animate-in fade-in slide-in-from-right-4 duration-700">
            ...
            <div className="hocker-panel-pro p-6 flex flex-col items-center justify-center text-center border-sky-500/20">
              <BrandMark showWordmark hero={false} className="scale-90 opacity-80" />
              <p className="mt-4 text-[10px] font-bold uppercase tracking-[0.2em] text-sky-400/80">
