    ...
    >
      <div className="flex flex-col gap-6 sm:gap-8">
        <Hint title="Visibilidad">
          Mira quién está activo y cuándo fue el último latido.
        </Hint>

        <div className="hocker-panel-pro relative overflow-hidden border-sky-500/10 hocker-page-enter">
          <div className="pointer-events-none absolute inset-0 opacity-[0.03]" style={{ backgroundImage: "radial-gradient(circle at center, #0ea5e9 2px, transparent 2px)", backgroundSize: "40px 40px" }} />
