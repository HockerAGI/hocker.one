    ...
    <section className="rounded-[34px] border border-white/6 bg-white/[0.03] p-6 shadow-[0_30px_120px_rgba(0,0,0,0.28)] backdrop-blur-2xl sm:p-7">
      <div className="space-y-2">
        ...
        <h2 className="text-2xl font-black tracking-tight text-white sm:text-3xl">
          Hocker ONE los observa, no los reemplaza.
        </h2>
        <p className="max-w-2xl text-sm leading-relaxed text-slate-400">
          `nova.agi` orquesta por HTTP. `hocker-node-agent` ejecuta por polling. Si aún no
          hay conexión, se muestra sin maquillaje.
        </p>
      </div>
