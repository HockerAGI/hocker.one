...
export const HOCKER_CLIENT_PORTALS: HockerClientPortal[] = [
  {
    ...
    name: "Hocker Ads Client App",
    brand_scope: "Hocker Ads",
    service_family: "growth_sales_technology",
    status: "planned",
    risk_level: "medium",
    controlled_by: "hocker-one",
    owner_panel_access: true,
    ...
    modules: ["home", "services", "projects", "advertising", "sales", "specialists", "business"],
    visible_to_client: ["inicio", "servicios", "proyectos", "publicidad", "ventas", "especialistas", "mi negocio"],
    ...
    notes: "Aplicación cliente separada de Hocker ONE. Hocker ONE conserva gobierno interno; esta entrada sigue siendo un descriptor planificado y no una ruta cliente operativa verificada.",
  },
  {
