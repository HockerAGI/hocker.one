...
export async function createServerSupabase() {
  ...
  if (!url || !key) {
    throw new Error(
      "Supabase server is not configured. Set NEXT_PUBLIC_SUPABASE_URL/SUPABASE_URL and SUPABASE_PUBLISHABLE_KEY, NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY, or NEXT_PUBLIC_SUPABASE_ANON_KEY.",
    );
  }
