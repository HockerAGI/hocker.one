...
test("AGI federation uses bounded canonical tasks and SYNTIA target propagation", async () => {
...
test("NOVA stream uses unified runtime and preserves web citations before compatibility fallback", async () => {
